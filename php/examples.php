...
$result = $mc->teststreamfilter((object)[], 'function filterstreamitem() {}'); // compile test only
$result = $mc->teststreamfilter(['libraries' => ['lib1', 'lib2']], 'function filterstreamitem() {}'); // with libraries
$result = $mc->teststreamfilter((object)[], 'function filterstreamitem() {}', $txhex); // test on transaction hex
$result = $mc->teststreamfilter((object)[], 'function filterstreamitem() {}', $txid); // test on previous transaction
...
$result = $mc->testtxfilter((object)[], 'function filtertransaction() {}'); // compile test only
...
$result = $mc->testtxfilter((object)[], 'function filtertransaction() {}', $txhex); // test on transaction hex
$result = $mc->testtxfilter((object)[], 'function filtertransaction() {}', $txid); // test on previous transaction
